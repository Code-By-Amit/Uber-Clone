...
export const RidePopup = ({ setRidePopUpPannel, setConfirmRidePopUpPannel }) => {
    return (
        ...
        <div>
            ...
            <h2 className='text-xl font-semibold my-2'>New Ride Available!</h2>
            ...
            <div className='flex gap-3 justify-between flex-col items-center'>
                ...
                <div className='flex w-full items-center justify-between'>
                    ...
                    }} className=' bg-gray-300 text-gray-800 font-semibold p-3 px-11 rounded-lg'>Ignore</button>

                    <button onClick={() => {
                        setConfirmRidePopUpPannel(true)
                    }} className=' bg-green-600 font-semibold p-3 text-white px-11 rounded-lg'>Accept</button>
                </div>
            </div>
        </div>
