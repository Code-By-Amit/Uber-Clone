...
export const FinishRide = ({setFinishRidePanel}) => {
    return (
        <div className='h-screen'>
            ...
            <h2 className='text-xl font-semibold my-2'>Confirm This Ride to Start</h2>
            ...
            <div className='flex gap-3 justify-between flex-col items-center'>
                ...
                <div className="mt-6 w-full">
                    ...
                    }} className='w-full mt-6 flex justify-center text-white bg-green-600 font-semibold p-2 rounded-lg'>Complete Ride</Link>
                </div>
            </div>
        </div>
    )
